export const ordersStyles = {
  ...
  filterContainer: "flex flex-wrap gap-2 mb-4 justify-center",
  filterButtonBase: "px-3 py-2 rounded-full text-xs font-medium tracking-wide transition-colors",
  filterButtonActive: "bg-black text-white shadow-sm",
  filterButtonInactive: "bg-gray-100 text-gray-600 hover:bg-gray-200",
