export const sponsorshipItemStyles = {
  ...
  subtitle: "text-[13px] sm:text-sm font-light text-black/60 transition-all duration-300 mt-2 px-3 py-2 rounded-xl bg-black/[0.03] border border-black/5",
  subtitleActive: "border-black/10 bg-black/[0.05]",
