export const sponsorshipPageStyles = {
  ...
  card: "w-[calc(100%-1rem)] sm:w-full max-w-[650px] flex flex-col bg-white rounded-[20px] px-6 pt-6 pb-10 sm:px-10 sm:pt-6 sm:pb-12 shadow-sm border border-[#d9d9d9]",
