...
function Button({ children, disabled = false, btnType = "primary", type = "button", onClick }: ButtonProps) {
  const base =
    "self-center w-[75%] sm:w-3/4 py-2 text-xl font-bold text-black bg-white border border-black hover:bg-black/[0.03] active:bg-black/[0.08] rounded-[14px] transition-colors duration-300 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed";
